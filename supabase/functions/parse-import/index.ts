...
async function extractJSON(system: string, content: unknown[], schema: Record<string, unknown>, maxTokens = 8000): Promise<any> {
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const out = await extractJSON(SYSTEM, content, SCHEMA, 8000)
